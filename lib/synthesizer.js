...
class Synthesizer {
    ...
    static getTopicType(topic, wikiSummary) {
        ...
        if (text.match(/virus|viral|influenza|coronavirus|covid|hiv|aids|hepatitis|herpes|ebola|zika|dengue|measles|rubella|rabies|rotavirus|papillomavirus/)) {
            return { entities: ["macrophage", "bacterium"], positions: { macrophage: { x: 0, y: 0, z: 0 }, bacterium: { x: 6, y: 1, z: 0 } }, cameraTarget: [3, 0.5, 0] };
        }
        if (text.match(/cell|organelle|mitochondri|ribosome|endoplasmic|golgi|lysosome|nucleus|membrane|cytoplasm|chromosome|gene|protein|enzyme/)) {
            return { entities: ["human_cell"], positions: { human_cell: { x: 0, y: 0, z: 0 } }, cameraTarget: [0, 0, 0] };
        }
        if (text.match(/disease|disorder|syndrome|cancer|carcinoma|sarcoma|leukemia|lymphoma|melanoma|glioma/)) {
            return { entities: ["human_cell", "bacterium"], positions: { human_cell: { x: 0, y: 0, z: 0 }, bacterium: { x: 5, y: 0, z: 0 } }, cameraTarget: [2.5, 0, 0] };
        }
        if (text.match(/physiology|process|mechanism|pathway|cascade|metabolism|transport|signaling|synaps|contraction/)) {
            return { entities: ["human_cell"], positions: { human_cell: { x: 0, y: 0, z: 0 } }, cameraTarget: [0, 0, 0] };
        }
        if (text.match(/anatomy|organ|tissue|muscle|bone|nerve|vessel|heart|lung|liver|kidney|brain|skin/)) {
            return { entities: ["human_cell"], positions: { human_cell: { x: 0, y: 0, z: 0 } }, cameraTarget: [0, 0, 0] };
        }
